...
| `--color-text-muted` | Timestamps, labels, secondary text | Subtext 0 | `#6e738d` |
| `--color-text-faint` | Placeholder, hint text | Overlay 0 | `#5b6078` |
...
| `--color-accent` | Interactive elements, focus rings | Peach (default) | `#f5a97f` |
