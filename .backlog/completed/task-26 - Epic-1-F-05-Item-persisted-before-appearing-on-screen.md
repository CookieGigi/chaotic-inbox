...
- [x] #1 Write to local storage completes synchronously with the capture event, before the block is rendered in the feed
- [x] #2 Force-quitting the app immediately after paste or drop → the item is present on next launch
<!-- AC:END -->
